		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Fiori App",
									"targetURL": "#demofioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demofioriapp-display": {
								"semanticObject": "demofioriapp",
								"action": "display",
								"description": "A Demo Fiori application.",
								"title": "Demo Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demofioriapp",
									"url": sap.ui.require.toUrl("demofioriapp")
								}
							}
						}
					}
